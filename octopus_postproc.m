...
mov               =VideoWriter(strcat('.\LAST RUN\Monopus dynamics solo'),'MPEG-4');
...
for ii=1:nsol                               % per ogni istante
    ...
    set(gca,'CameraPosition',[urx_now+(Lr+Lb) ury_now+(Lr+Lb) urz_now+(Lr+Lb)],...           % comera fixed to ambient (E1,E2,E3)
